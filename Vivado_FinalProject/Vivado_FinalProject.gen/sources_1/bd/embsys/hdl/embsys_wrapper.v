...
module embsys_wrapper
  ...
  output clk_out3_0;
  output dp_0;
  input [31:0]gpio_relay_i_tri_i;
  input [7:0]gpio_rtl_0_tri_i;
  output [7:0]gpio_rtl_1_tri_o;
  input [31:0]gpio_stepx_i_tri_i;
  input [31:0]gpio_stepy_i_tri_i;
  input [31:0]gpio_stepz_i_tri_i;
  output [15:0]led_0;
  output [6:0]seg_0;
  input [15:0]sw_0;
  input sysclk;
  ...
  wire clk_out3_0;
  wire dp_0;
  wire [31:0]gpio_relay_i_tri_i;
  wire [7:0]gpio_rtl_0_tri_i;
  wire [7:0]gpio_rtl_1_tri_o;
  wire [31:0]gpio_stepx_i_tri_i;
  wire [31:0]gpio_stepy_i_tri_i;
  wire [31:0]gpio_stepz_i_tri_i;
  wire [15:0]led_0;
  wire [6:0]seg_0;
  wire [15:0]sw_0;
  wire sysclk;
  ...
  embsys embsys_i
       (.PmodOLEDrgb_out_0_pin10_i(PmodOLEDrgb_out_0_pin10_i),
        ...
        .dp_0(dp_0),
        .gpio_relay_i_tri_i(gpio_relay_i_tri_i),
        .gpio_rtl_0_tri_i(gpio_rtl_0_tri_i),
        .gpio_rtl_1_tri_o(gpio_rtl_1_tri_o),
        .gpio_stepx_i_tri_i(gpio_stepx_i_tri_i),
        .gpio_stepy_i_tri_i(gpio_stepy_i_tri_i),
        .gpio_stepz_i_tri_i(gpio_stepz_i_tri_i),
        .led_0(led_0),
        .seg_0(seg_0),
        .sw_0(sw_0),
        .sysclk(sysclk),
