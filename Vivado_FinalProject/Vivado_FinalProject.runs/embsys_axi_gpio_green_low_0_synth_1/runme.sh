...
HD_PWD='D:/PortlandState/ECE_544/Labs/project_1/Project_1.runs/embsys_axi_gpio_green_low_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_axi_gpio_green_low_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_axi_gpio_green_low_0.tcl
