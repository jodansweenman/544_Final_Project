...
-- Date        : Sat May  7 17:15:52 2022
-- Host        : RUN-20 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/PortlandState/ECE_544/Labs/project_2/project_2.gen/sources_1/bd/embsys/ip/embsys_fit_timer_0_0/embsys_fit_timer_0_0_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \embsys_fit_timer_0_0_Divide_part__parameterized1_1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \embsys_fit_timer_0_0_Divide_part__parameterized1_1\ : entity is "Divide_part";
end \embsys_fit_timer_0_0_Divide_part__parameterized1_1\;

architecture STRUCTURE of \embsys_fit_timer_0_0_Divide_part__parameterized1_1\ is
...
entity embsys_fit_timer_0_0_FIT_timer is
  ...
  attribute C_NO_CLOCKS of embsys_fit_timer_0_0_FIT_timer : entity is 1000000;
  attribute ORIG_REF_NAME : string;
...
\Using_SRL16s.SRL16s[4].Divide_I\: entity work.\embsys_fit_timer_0_0_Divide_part__parameterized1\
     port map (
      CE => CE_4,
      CE_0 => CE_2,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[5].Divide_I\: entity work.\embsys_fit_timer_0_0_Divide_part__parameterized1_1\
     port map (
      CE => CE_6,
      CE_0 => CE_4,
      Clk => Clk,
